    ...
    <el-table :data="tableList" stripe border fit empty-text="暂无数据" style="width: 100%;">
      ...
      >
        <template slot-scope="{row}">
          <div style="white-space: normal;">{{row.addressInPark}}</div>
        </template>
      </el-table-column>
      <el-table-column prop="status" align="center" label="审核状态" width="100"></el-table-column>
      <el-table-column prop="applyAuthTime" align="center" label="申请日期" width="140"></el-table-column>
    ...
    <el-drawer title="复工申请详情" :visible.sync="detailVis" size="40%" direction="rtl">
      <div class="dra-wrapper">
        <div class="content">
          ...
          <div class="detail-name">
            ...
            <div class="ls-cen">
              ...
              <span class="ls-cen-con">{{detail.applyAuthTime}}</span>
            </div>
            <div class="ls-cen">
        ...
        <div class="content">
          ...
          <div class="detail-name">
            <div class="ls-cen">
              <span class="ls-cen-title">员工数量：</span>
              <span class="ls-cen-con">{{detail.employeeCount}}</span>
            </div>
            <div class="ls-cen">
              <span class="ls-cen-title">联系人：</span>
              <span class="ls-cen-con">{{detail.contactName}}</span>
            </div>
            <div class="ls-cen">
              <span class="ls-cen-title">联系电话：</span>
              <span class="ls-cen-con">{{detail.contactPhone}}</span>
            </div>
          </div>
        </div>
        <div class="content">
          <h4>营业执照</h4>
          <div class="detail-name">
            <img v-if="detail.businessLicense" :src="detail.businessLicense" style="width:150px" />
          </div>
        </div>
      </div>
    </el-drawer>
...
import {
  ...
  getAuthType,
  reworkAudit
} from "@/myApi/companyInfo/companyInfo";
const formLable = [
  //表单需要的参数,搜索表单
  {
